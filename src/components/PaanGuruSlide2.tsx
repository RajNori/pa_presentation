...
export default function PaanGuruSlide2({
    slideNumber,
    title,
    subtitle,
    bulletPoints,
                ...
                <div
                    ...
                    <div className='w-full md:w-1/2 text-center md:text-left overscroll-none'>
                        ...
                        <div className='mt-4 p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20'>
                            <p
                                className='text-xs sm:text-sm md:text-base font-medium leading-relaxed break-words'
                                style={{ color: textColor }}>
                                {ceoInfo}
                            </p>
                        </div>
                    ...
                    <div className='w-full md:w-1/2 flex items-center justify-center overscroll-none'>
                        <div className='w-full max-w-md'>
                            <img
                                src='/slide2.png'
                                alt='The Irresistible Opportunity'
